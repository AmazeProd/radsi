...
const Navbar = () => {
  ...
  if (!isAuthenticated) {
    return (
      <nav className="bg-white dark:bg-black shadow-md transition-colors border-b dark:border-gray-900">
  ...
  return (
    <nav className="bg-white dark:bg-black border-b border-gray-200 dark:border-gray-900 sticky top-0 z-50 shadow-sm transition-colors">
      ...
      {/* Mobile Navigation */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-white dark:bg-black border-t dark:border-gray-900 transition-colors">
