...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-black text-gray-700 dark:text-gray-300 mt-auto border-t border-gray-200 dark:border-gray-900 transition-colors">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-xl font-bold bg-gray-100 dark:bg-gray-950 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-900 text-gray-900 dark:text-gray-100">
              Naitik Tiwari
            </p>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-900">
