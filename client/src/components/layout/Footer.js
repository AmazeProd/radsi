        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            <div className="flex items-center gap-3">
              <img src="/assets/logotext.png" alt="Radsi Corp" className="h-14 w-auto filter brightness-0 invert" />
            </div>
        ...
        <div className="mt-8 pt-6 border-t border-github-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-primary-300 flex items-center gap-1">
              © {new Date().getFullYear()} <img src="/assets/logotext.png" alt="Radsi" className="h-5 w-auto filter brightness-0 invert inline-block" /> Corp. All rights reserved.
            </p>
