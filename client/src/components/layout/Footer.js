...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gradient-to-r dark:from-gray-900 dark:to-gray-950 text-gray-700 dark:text-gray-300 mt-auto border-t border-gray-200 dark:border-gray-800 transition-colors">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-xl font-bold bg-gray-100 dark:bg-gray-900 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-gray-100">
              Naitik Tiwari
            </p>
          </div>
        </div>
