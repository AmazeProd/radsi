...
const Messages = () => {
  ...
  return (
    <div className="h-screen bg-[var(--bg-canvas)] transition-colors overflow-hidden">
      <div className="h-full w-full max-w-full overflow-hidden flex">
        ...
        {/* Messages Area */}
        <div 
          className={(selectedUser ? 'flex' : 'hidden md:flex') + ' flex-1 flex-col h-full overflow-hidden relative min-w-0'}
          style={{
          ...
          {selectedUser ? (
            <>
              ...
              <div 
                ...
                className="flex-1 overflow-y-scroll overflow-x-hidden p-3 sm:p-4 space-y-3 max-w-full"
                style={{
                  minHeight: 0,
                  maxHeight: '100%',
