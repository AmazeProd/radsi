...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-md shadow-sm z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          <div className="flex items-center gap-2 sm:gap-3">
            <img src="/assets/logotext.png" alt="Radsi Corp" className="h-12 sm:h-14 w-auto" />
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-16 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
                <Link
                  to="/register"
                  className="bg-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-semibold hover:bg-blue-700 transition shadow-xl shadow-blue-600/30 flex items-center justify-center gap-2"
                >
                  Start Free Trial
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
            <Link
              to="/register"
              className="bg-white text-blue-600 px-8 sm:px-10 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-bold hover:bg-gray-50 transition shadow-2xl inline-flex items-center justify-center gap-2"
            >
              Start Free Trial
              <FiZap size={18} className="sm:w-5 sm:h-5" />
            </Link>
            <Link
              to="/login"
              className="bg-transparent border-2 border-white text-white px-8 sm:px-10 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-bold hover:bg-white/10 transition inline-flex items-center justify-center gap-2"
            >
              Sign In
            </Link>
          </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 sm:py-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex justify-center items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <img src="/assets/logotext.png" alt="Radsi" className="h-10 sm:h-12 w-auto filter brightness-0 invert" />
          </div>
          <p className="text-xs sm:text-sm">
            © 2025 <img src="/assets/logotext.png" alt="Radsi" className="h-5 sm:h-6 w-auto inline-block filter brightness-0 invert" /> Corporation. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
